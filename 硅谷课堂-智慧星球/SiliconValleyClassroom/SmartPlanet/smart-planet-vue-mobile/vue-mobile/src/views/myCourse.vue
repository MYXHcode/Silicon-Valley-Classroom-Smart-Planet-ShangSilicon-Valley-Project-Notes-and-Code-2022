    ...
    <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
      ...
      >
        ...
        >
          ...
          <template #footer>
            <van-button size="mini" @click="see(item.courseId)"
              >去观看</van-button
            >
          </template>
        </van-card>
          ...
          <li v-for="(item, index) in list" :key="index">
            ...
            <div class="list-box">
              <ul>
                ...
                <li>
                  <span style="color: red">￥{{ item.finalAmount }}</span>
                </li>
              </ul>
              <br />
              <p>
                <van-button @click="see(item.courseId)" type="info" size="mini"
                  >去观看</van-button
                >
              </p>
            </div>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      orderAPI
        .findCourseListPage(this.pageNo, this.pageSize)
        .then((response) => {

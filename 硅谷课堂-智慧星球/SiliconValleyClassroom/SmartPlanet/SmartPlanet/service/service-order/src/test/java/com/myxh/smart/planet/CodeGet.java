...
public class CodeGet
{
    public static void main(String[] args)
    {
        ...
        // 2、设置数据源配置
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/smart_planet_order", "MYXH", "520.ILY!")
                // 3、设置全局配置
                .globalConfig(builder ->
                {
                    ...
                    builder.author("MYXH")
                            ...
                            .disableOpenDir()
                            // 设置输出目录
                            .outputDir("service\\service-order\\src\\main\\java");
                ...
                .strategyConfig(builder ->
                {
                    // 设置需要生成的表名
                    builder.
                            addInclude("order_info", "order_detail")
                            // 设置过滤表前缀
